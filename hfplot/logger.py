...
class AliPlotLoggerFormatter(logging.Formatter):
    """
...
def configure_logger(debug, logfile=None):
    ...
    """
    logger = logging.getLogger("AliPlotLogger")
    ...
    if logfile is not None:
        ...
        fh.setFormatter(AliPlotLoggerFormatter())
...
def get_logger():
    ...
    return logging.getLogger("AliPlotLogger")
